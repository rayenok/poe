...
(let ((fg "#e5e5e5")
 ...
 (custom-theme-set-faces 'poe
  ...
  `(org-level-1 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1)))))))
  `(org-level-2 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1)))))))
  `(org-level-3 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1)))))))
  `(org-level-4 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1)))))))
  `(org-level-5 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1)))))))
  `(org-level-6 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1)))))))
  `(org-level-7 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1)))))))
  `(org-level-8 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1)))))))
  ;; `(org-level-1 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.8)))))))
  ;; `(org-level-2 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.4)))))))
  ;; `(org-level-3 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.3)))))))
  ;; `(org-level-4 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ;; `(org-level-5 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ;; `(org-level-6 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ;; `(org-level-7 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ;; `(org-level-8 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ;; `(org-level-1 ((t (:inherit default :foreground ,org-title :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.8))) :underline (:color ,org-title-underline)))))
  ;; `(org-level-2 ((t (:inherit default :foreground ,header :background "gray8" :extend t :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.4)))))))
  ;; `(org-level-3 ((t (:inherit default :foreground ,header :background "gray8" :extend t :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.3)))))))
  ;; `(org-level-4 ((t (:inherit default :foreground ,header :background "gray8" :extend t :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ;; `(org-level-5 ((t (:inherit default :foreground ,header :background "gray8" :extend t :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ;; `(org-level-6 ((t (:inherit default :foreground ,header :background "gray8" :extend t :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ;; `(org-level-7 ((t (:inherit default :foreground ,header :background "gray8" :extend t :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ;; `(org-level-8 ((t (:inherit default :foreground ,header :background "gray8" :extend t :height (lambda (base) (truncate (* (face-attribute 'fixed-pitch :height nil 'default) 1.23)))))))
  ...
  `(org-verbatim ((t (:inherit fixed-pitch :background "gray20"))))
  ...
  '(iedit-occurrence ((t (:inherit highlight :background "yellow" :foreground "black"))))
  '(org-block-begin-line ((t nil)))
  '(org-block-end-line ((t (:inherit fixed-pitch))))
  '(org-verbatim ((t (:inherit fixed-pitch :foreground "#eeeeec" :box (:line-width 2 :color "grey75" :style pressed-button) :underline t :slant italic))))
  ...
  '(hl-line ((t (:extend t :background "gray15"))))
  ...
  '(helm-ff-file ((t (:foreground "snow"))))
  '(helm-selection ((t (:background "gray20" :foreground "snow"))))
  ;; parenthesis
  '(sp-show-pair-match-face ((t (:background "gray20" :foreground "yellow" :underline t))))
  '(sp-wrap-overlay-closing-pair ((t nil)))
  '(sp-wrap-overlay-opening-pair ((t nil)))
  ;; region/selection
  '(region ((t (:background "LightCyan4" :foreground "snow"))))
  ;; company
  '(company-tooltip ((t (:background "gray15" :foreground "snow"))))
  '(company-scrollbar-bg ((t (:background "black"))))
  '(company-tooltip-annotation ((t (:foreground "SpringGreen4"))))
  '(company-tooltip-annotation-selection ((t (:foreground "SpringGreen4"))))
  '(company-tooltip-common ((t (:foreground "yellow"))))
  '(company-tooltip-common-selection ((t (:foreground "yellow"))))
  '(company-tooltip-selection ((t (:background "black"))))
  '(ediff-even-diff-A nil :background "gray20")
  '(ediff-even-diff-B nil :background "gray20")
  '(ediff-even-diff-C nil :background "gray20")
  '(ediff-odd-diff-A nil :background "gray20")
